<html>
 ...
 <body class="bg-gray-100">
  <div class="relative bg-gradient-to-r from-orange-400 to-orange-500 text-white text-center py-16 mx-2 mt-2 rounded-lg overflow-hidden">
   <img alt="Background buildings" class="absolute inset-0 w-full h-full object-cover opacity-20" height="1080" src="{{ asset('images/background-building.jpg') }}" width="1920"/>
   <div class="relative z-10">
    <img alt="Radnext logo" class="mx-auto mb-6" height="50" src="{{ asset('images/radnet-logo2.png') }}" width="100"/>
    ...
    <div class="mt-10 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
     <input class="rounded-full py-3 px-6 text-gray-700 w-3/4 sm:w-1/2 max-w-md shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="tulis nomor sertifikat" type="text"/>
     <button class="bg-blue-600 text-white rounded-full py-3 px-8 shadow-lg hover:bg-blue-700 transition duration-300">
      Search
     </button>
    </div>
   </div>
